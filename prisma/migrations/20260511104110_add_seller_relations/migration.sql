...
ADD COLUMN     "sellerApprovedBy" INTEGER,
ADD COLUMN     "sellerRating" DOUBLE PRECISION NOT NULL DEFAULT 0,
ADD COLUMN     "sellerStatus" "SellerStatus",
ADD COLUMN     "sellerTotalReviews" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "sellerTotalSales" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "shopBanner" TEXT,
